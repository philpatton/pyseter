...
You can also check out [the demo version Hugging Face](https://huggingface.co/spaces/pattonp/pyseter-app-demo). The demo version contains a subset of the Happywhale dataset.
...
Here, we demonstrate what the app looks like when you run it locally. This demo version contains 68 images from the Happywhale dataset, and represents a roughly even sample of every catalog in the dataset. You can also check out [the demo version Hugging Face](https://huggingface.co/spaces/pattonp/pyseter-app-demo).
